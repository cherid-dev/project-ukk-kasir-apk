...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo ">
        <a href="#" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-semibold ms-2">Minishop</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header fw-medium mt-4">
            <span class="menu-header-text" data-i18n="Data">Data</span>
        </li>
        <!-- Kategori -->
        <li class="menu-item {{ Request::is('admin/kategori*') ? 'active' : '' }}">
            <a href="{{ route('kategoriadmin') }}" class="menu-link">
        ...
        <li class="menu-item {{ Request::is('admin/produk*') ? 'active' : '' }}">
            <a href="{{ route('produkadmin') }}" class="menu-link">
        ...
        <li class="menu-item {{ Request::is('admin/member*') ? 'active' : '' }}">
            <a href="{{ route('memberadmin') }}" class="menu-link">
        ...
        <li class="menu-item {{ Request::is('admin/supplier*') ? 'active' : '' }}">
            <a href="{{ route('supplieradmin') }}" class="menu-link">
        ...
        <!-- Pembelian -->
        <li class="menu-item {{ Request::is('admin/pembelian*') ? 'active' : '' }}">
            <a href="/admin/pembelian" class="menu-link">
                <i class="menu-icon tf-icons mdi mdi-cart-arrow-down"></i>
                <div data-i18n="Pembelian">Pembelian</div>
            </a>
        </li>
        <!-- Penjualan -->
        <li class="menu-item {{ Request::is('admin/penjualan*') ? 'active' : '' }}">
            <a href="/admin/penjualan" class="menu-link">
                <i class="menu-icon tf-icons mdi mdi-cart-arrow-up"></i>
