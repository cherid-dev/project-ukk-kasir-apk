...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h5 class="py-3 mb-4">Supplier</h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="text-muted float-end"><a href="{{ route('tambahsupplieradmin') }}"
                                    ...
                                    <tbody>
                                        @foreach ($supplier as $m)
                                            <tr>
                                                ...
                                                <td class="text-truncate">{{ $m->nama_supplier }}</td>
                                                ...
                                                <td>
                                                    <div class="dropdown text-center">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="supplier/edit/{{$m->id}}"><i class="mdi mdi-pencil-outline me-1"></i> Edit</a>
                                                            <a class="dropdown-item" href="supplier/hapus/{{$m->id}}"><i class="mdi mdi-trash-can-outline me-1"></i> Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
