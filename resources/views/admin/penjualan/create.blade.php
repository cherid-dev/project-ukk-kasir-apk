                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('detailpenjualanadmin') }}" method="post">
                                @csrf
                                        ...
                                        @foreach ($detailpenjualan as $dp)
                                            <tr>
                                                ...
                                                <td class="text-truncate"><a
                                                        href="/admin/penjualan/detail/hapus?id={{ $dp->id }}"><i
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3 d-flex">
                                ...
                                <div class="col-sm-9">
                                    <form action="{{ route('memberpenjualanadmin') }}" method="post">
                                        @csrf
                                        <input type="hidden" name="id_penjualan" value="{{ Request::segment(3) }}">
                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('updatepenjualanadmin') }}" method="post">
                                @csrf
                                <input type="hidden" name="id_penjualan" value="{{ Request::segment(3) }}">
