...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h5 class="py-3 mb-4">Kategori</h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="text-muted float-end"><a href="{{ route('tambahkategoriadmin') }}"
                                ...
                                <table class="table table-hover" id="datatable">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th class="text-truncate text-center">Nama Kategori</th>
                                    ...
                                    <tbody>
                                        @foreach ($kategori as $k)
                                            <tr>
                                                ...
                                                <td class="text-truncate">{{ $k->nama_kategori }}</td>
                                                <td>
                                                    <div class="dropdown text-center">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item"
                                                                href="kategori/edit/{{ $k->id }}"><i
                                                                    class="mdi mdi-pencil-outline me-1"></i> Edit</a>
                                                            <a class="dropdown-item"
                                                                href="kategori/hapus/{{ $k->id }}"><i
