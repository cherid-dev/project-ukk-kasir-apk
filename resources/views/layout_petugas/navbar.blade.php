...
<nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        ...
        {{-- <div class="navbar-nav align-items-center">
            <div class="nav-item navbar-search-wrapper mb-0">
                <marquee behavior="" direction="right">Selamat datang</marquee>
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <ul class="dropdown-menu dropdown-menu-end py-0">
                        ...
                        <ul class="list-group list-group-flush">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <div class="flex-shrink-0">
                                        <div class="avatar me-1">
                                            <img src="{{ asset('assets/template') }}/assets/img/avatars/1.png" alt
                            ...
                            <li
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <div class="flex-shrink-0">
                                        <div class="avatar me-1">
                                            <img src="{{ asset('assets/template') }}/assets/img/avatars/2.png" alt
                                                class="w-px-40 h-auto rounded-circle">
                                        </div>
                                    </div>
                                    <div
                            ...
                            <li
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <div class="flex-shrink-0">
                                        <div class="avatar me-1">
                                            <img src="{{ asset('assets/template') }}/assets/img/avatars/9.png" alt
                                                class="w-px-40 h-auto rounded-circle">
                                        </div>
                                    </div>
                                    <div
                            ...
                            <li
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <div class="flex-shrink-0">
                                        <div class="avatar me-1">
                                            <img src="{{ asset('assets/template') }}/assets/img/avatars/5.png" alt
                                                class="w-px-40 h-auto rounded-circle">
                                        </div>
                                    </div>
                                    <div
                            ...
                            <li
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <div class="flex-shrink-0">
                                        <div class="avatar me-1">
                                            <img src="{{ asset('assets/template') }}/assets/img/avatars/6.png" alt
                                                class="w-px-40 h-auto rounded-circle">
                                        </div>
                                    </div>
                                    <div
                    ...
                    <li class="dropdown-menu-footer border-top p-3">
                        <a href="javascript:void(0);"
                            class="btn btn-primary d-flex justify-content-center">Read all
                            notifications</a>
                    </li>
                </ul>
            </li> --}}
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        @if (Auth::user()->avatar)
                            ...
                            class="w-px-40 h-auto rounded-circle">
                        @else
                            <img src="{{ asset('storage/avatar/1.png') }}" alt
                            class="w-px-40 h-auto rounded-circle">
                        @endif
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end mt-3 py-2">
                    <li>
                        <a class="dropdown-item pb-2 mb-1" href="{{ route('profilpetugas') }}">
                    ...
                    <li>
                        <a class="dropdown-item" href="{{ route('profilpetugas') }}">
    ...
    <div class="navbar-search-wrapper search-input-wrapper  d-none">
        <input type="text" class="form-control search-input container-xxl border-0"
            placeholder="Search{{ asset('assets/template') }}." aria-label="Search{{ asset('assets/template') }}.">
