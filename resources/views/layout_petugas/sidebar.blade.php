...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- Penjualan -->
        <li class="menu-item {{ Request::is('petugas/penjualan*') ? 'active' : '' }}">
            <a href="/petugas/penjualan" class="menu-link">
        ...
        <!-- Produk -->
        <li class="menu-item {{ Request::is('petugas/produk*') ? 'active' : '' }}">
            <a href="{{ route('produkpetugas') }}" class="menu-link">
                <i class="menu-icon tf-icons mdi mdi-shopping-outline"></i>
                <div data-i18n="Produk">Produk</div>
            </a>
        </li>
        <!-- Member -->
        <li class="menu-item {{ Request::is('petugas/member*') ? 'active' : '' }}">
            <a href="{{ route('memberpetugas') }}" class="menu-link">
