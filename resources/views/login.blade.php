                ...
                <div class="card p-2">
                    ...
                    <div class="app-brand justify-content-center mt-5">
                        <a href="index.html" class="app-brand-link gap-2">
                            ...
                            <span class="app-brand-text demo text-heading fw-semibold">Minishop</span>
                        </a>
                    </div>
                    <!-- /Logo -->

                    <div class="card-body mt-2">
                        <h4 class="mb-2">Selamat Datang di Minishop! 👋</h4>
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('actionlogin') }}" method="post">
                            ...
                            <div class="form-floating form-floating-outline mb-3">
                                <input type="text" class="form-control" id="email" name="username"
                                    placeholder="Masukkan username kamu" value="{{ old('username') }}" autofocus />
